...
inputXmlDir = userHome + '/gradledoc/foo/gradle-0.8/src/docs/userguide'

// the directory where the generated userguide html files are located
inputHtmlDir = userHome + '/opt/gradle-0.8/docs/userguide'

// files in the generated userguide html file directory that should
// not be included in the resulting epub file
