...
class ImageLoaderCache extends Dictionary<String, Image> {
  ...
  private static final Logger log = Logger.create(ImageLoaderCache.class);
  ...
  private String getResourceHref(String requestUrl) {
    String resourceHref = requestUrl.toString()
        .substring(IMAGE_URL_PREFIX.length());
  ...
  public Enumeration<String> keys() {
    return CollectionUtil
        .createEnumerationFromIterator(cache.keySet().iterator());
  }

  public Enumeration<Image> elements() {
    return CollectionUtil
        .createEnumerationFromIterator(cache.values().iterator());
  }
