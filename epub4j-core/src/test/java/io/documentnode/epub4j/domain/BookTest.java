...
public class BookTest {
	...
	public void testGetContents1() {
		Book book = new Book();
		Resource resource1 = new Resource("id1", "Hello, world !".getBytes(), "chapter1.html", MediaTypes.XHTML);
	...
	public void testGetContents2() {
		...
		Resource resource1 = new Resource("id1", "Hello, world !".getBytes(), "chapter1.html", MediaTypes.XHTML);
		book.getSpine().addResource(resource1);
		Resource resource2 = new Resource("id1", "Hello, world !".getBytes(), "chapter2.html", MediaTypes.XHTML);
	...
	public void testGetContents4() {
		...
		Resource resource3 = new Resource("id1", "Hello, world !".getBytes(), "foreword.html", MediaTypes.XHTML);
